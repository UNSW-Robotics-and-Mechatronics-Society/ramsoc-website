# 🗄️ Project Structure [(From Bulletproof React)](https://github.com/alan2207/bulletproof-react/blob/master/docs/project-structure.md)
...
|   +-- pages.tsx     # the page displayed on this route
|   +-- layout.tsx    # shared layout of the application
|
...
<img
  src="/primary website/unidirectional-codebase.png"
  alt="unidirectional codebase"
></img>
